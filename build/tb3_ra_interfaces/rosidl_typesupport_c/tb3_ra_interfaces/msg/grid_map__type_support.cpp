...
static const _GridMap_type_support_symbol_names_t _GridMap_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tb3_ra_interfaces, msg, GridMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tb3_ra_interfaces, msg, GridMap)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tb3_ra_interfaces, msg, GridMap)() {
  return &::tb3_ra_interfaces::msg::rosidl_typesupport_c::GridMap_message_type_support_handle;
}
