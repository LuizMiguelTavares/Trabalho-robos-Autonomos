...
static const _GridMap_type_support_symbol_names_t _GridMap_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tb3_ra_interfaces, msg, GridMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tb3_ra_interfaces, msg, GridMap)),
  }
};
...
{
  return &::tb3_ra_interfaces::msg::rosidl_typesupport_cpp::GridMap_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tb3_ra_interfaces, msg, GridMap)() {
  return get_message_type_support_handle<tb3_ra_interfaces::msg::GridMap>();
}
